...
P3's primary innovation is to replace the generational model with the pyramid model,
in which multiple populations are iteratively created and expanded. In combination
...
the same number of evaluations. From algorithm analysis and comparison we find P3's
effectiveness is likely due to its ability to properly maintain, add, and exploit diversity.
