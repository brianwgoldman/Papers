...
Black-Box P3 was 375 times slower than Gray-Box P3. Using the Mann-Whitney test to compare the two run times
...
4.6 times slower than Gray-Box on $N=2,025$. Using the Mann-Whitney test to compare the two run times
