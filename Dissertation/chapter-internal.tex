...
the distribution of results when solving the largest size of each
problem. On each problem
% wfp
...
When compared with LTGA, P3's crossover success rates are lower but 
% wfp
show the same problem ordering, from least to most effective.
% wfp similar in problem ordering.
...
% wfp it's still critical to optimization. 
Without
