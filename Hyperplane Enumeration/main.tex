...
mean time to find all local optima all but 2 times. In both cases Hyper-Reorder was within a tenth of a second
of the best method.
...
column we should the growth rate of the number of local optima. It is impossible for any method
...
non-linear relationships per variable. Random NKq and MAX-kSAT both increase with problem
size, with Random NKq ranging between 5 and 6. With $N=15$, MAX-kSAT has on average nearly
