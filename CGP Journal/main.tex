...
challenge.  By examining tuned parameter values, the search quality of CGP variants at different
problem difficulties, node behavior, and offspring replacement properties we
seek to comprehend observed characteristics of CGP search.  Our focus is twofold:
methods to prevent wasted CGP evaluations (\emph{Skip}, \emph{Accumulate},
...
the least amount of time with the least amount of degenerate
behavior.
...
node at index $i$, times the probability that the node at index $j$ is active.  This is
...
11.5 billion evaluations were performed to gather our results.
...
%TODO Reference here again the probability function, and its ability to predict values
