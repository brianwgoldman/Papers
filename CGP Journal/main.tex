...
combination on each problem are summarized by Table~\ref{tab:parity},
Table~\ref{tab:encode}, Table~\ref{tab:decode}, and Table~\ref{tab:multiply}.
...
observation that in for Parity and Encode (Table~\ref{tab:parity} and Table~\ref{tab:encode})
the first column is effectively sorted, while for Decode and Multiply
(Table~\ref{tab:decode} and Table~\ref{tab:multiply}) the second column is sorted.
...
in Table~\ref{tab:parity}, Table~\ref{tab:encode}, Table~\ref{tab:decode}, and Table~\ref{tab:multiply}
...
Table~\ref{tab:parity}, Table~\ref{tab:encode}, Table~\ref{tab:decode},
and Table~\ref{tab:multiply} provide two column relevant to node behavior: Active
...
\textbf{Duplicate} & \textbf{Ordering} & \textbf{Active Unchanged} & \textbf{No Reactivation} & \textbf{Reactivated Changed} \\ \hline
 ...
 \emph{Accumulate} &  \emph{Normal} & 2.69\% & 39.99\% & 67.27\% \\ \hline
     ...
     \emph{Single} &     \emph{DAG} & 27.80\% & 83.73\% & 59.92\% \\ \hline
	\end{tabular}
	\caption{Parity}
	\label{tab:parity_reactivate}
\end{table*}
...
\textbf{Duplicate} & \textbf{Ordering} & \textbf{Active Unchanged} & \textbf{No Reactivation} & \textbf{Reactivated Changed} \\ \hline
 ...
 \emph{Accumulate} &  \emph{Normal} & 14.52\% & 54.79\% & 64.17\% \\ \hline
     ...
     \emph{Single} & \emph{Reorder} & 39.95\% & 78.91\% & 59.72\% \\ \hline
	\end{tabular}
	\caption{Encode}
	\label{tab:encode_reactivate}
\end{table*}
...
\textbf{Duplicate} & \textbf{Ordering} & \textbf{Active Unchanged} & \textbf{No Reactivation} & \textbf{Reactivated Changed} \\ \hline
 ...
 \emph{Accumulate} &  \emph{Normal} & 51.11\% & 84.54\% & 72.57\% \\ \hline
   \rowcolor{Gray}
       \emph{Skip} &  \emph{Normal} & 65.47\% & 89.17\% & 72.21\% \\ \hline

	\end{tabular}
	\caption{Decode}
	\label{tab:decode_reactivate}
\end{table*}
...
Table~\ref{tab:parity_reactivate}, Table~\ref{tab:encode_reactivate},
Table~\ref{tab:decode_reactivate}, and Table~\ref{tab:multiply_reactivate} provide a
