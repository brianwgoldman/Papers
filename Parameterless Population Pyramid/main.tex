...
%Maximum 200 Words
  ...
  is an evolutionary technique that both requires \textbf{no}
  parameters and is broadly effective. P3 strikes a balance between
  continuous integration of diversity with exploitative elitist
  ...
  optimum at least a constant factor \emph{\textbf{faster}} as shown
  on four benchmarks (Deceptive Trap, Deceptive Step Trap,
  Hierarchical If and only If, Rastrigin).  More importantly, on three
  ...
  evaluations.  Based on over 1 trillion evaluations, our results
  suggest P3 has wide applicatiblity to a broad class of real world
  problems.
\end{abstract}
...
added to $P_2$ because it not a strict fitness improvement over
