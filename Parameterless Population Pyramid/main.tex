...
as such all reported results for LTGA use independent runs to create a testing phase.
...
exception for $(1+(\lambda,\lambda))$ on the deceptive trap problem, where it appears
