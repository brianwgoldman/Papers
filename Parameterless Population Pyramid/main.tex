...
optima.  This allows us to measure how many evaulations each method requires to converge to the
...
While in practice it is often more important to find a good solution quickly
than to find the optimum after an exceedingly long time, using this as a measure
for algorithm quality can lead to algorithms which prematurely converge.
...
other solutions that also satisfy all clauses.
...
TODO Compare LTGA results with previously published results as best as possible.
